...
<h1>
    to use it you must install it using the command => npm install axios
</h1>

<h1>
    normally fetch is asynchronous , it doesn't block the code while waiting for the response
    it returns promises
</h1>
